  ...
  return (
    <div>
      <MenuBar />
        ...
        <div className="md:flex md:flex-col md:justify-center md:items-center">
          <p className="text-[25px] ml-6 mt-50">Trying to contact me?</p>
          <p className="ml-6 text-[gray]">checkout for these</p>
          <div className="md:flex md:flex-row md:gap-5 scrollable md:h-0 w-80 md:w-235 m-7">
            <div className="flex mt-0 md:mt-5">
